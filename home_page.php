...
>>>>>>> parent of ca77a95... En fait la connexion marche pas trop mais ça passe
            </form>
        </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-4 well well-sm">
                          ...
                          <div class="row">
                              <div class="col-xs-4 col-md-4">
                                  <select name="date_naissance[]" class="form-control">
                              ...
                              <div class="col-xs-4 col-md-4">
                                  <select name="mois_naissance[]" class="form-control">
                              ...
                              <div class="col-xs-4 col-md-4">
                                  <select name="annee_naissance[]" class="form-control">
                                      <option value="Year">Année</option>
                                      <?PHP for ($a = 1926; $a < 2006; $a++)
                                      {
                          ...
                          <?php                           
                              ...
                              <option value="<?php echo $donnees['id_ville']; ?>"><?php echo $donnees['code_postal']; ?></option>
                             <?php } ?>
                          ...
                          <?php                           
                              $reponse = $bdd->query('select * from ville'); 
                              while ($donnees = $reponse->fetch()){ ?>
                              <option value="<?php echo $donnees['id_ville']; ?>"><?php echo $donnees['libelle_ville']; ?></option>
                             <?php } ?>                          
                          </select>                          
